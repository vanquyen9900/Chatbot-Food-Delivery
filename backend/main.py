...
async def handle_request(request: Request):
    ...
    #Extract the nescessary information from the payload
...
def  remove_from_order(parameters: dict,session_id: str):
    ...
    if len(current_order.keys()) == 0:
        fullfillment_text += "Your order is now empty"
    else:
...
def add_to_order(parameters: dict,session_id: str):
    ...
    if len(food_item) != len(quantities):
        fullfillment_text = "Sorry I didn't understand. Can you please specify food items and quantities."
    else:
